(function () {
    ...
    var KNOWLEDGE = [
        { keys: ['hello', 'hi', 'hey'], answer: "Hello! I'm the HealingTech Initiative assistant. Ask me about our programs, partnership with HealingTech Labs, volunteering, or how to get involved." },
        ...
        { keys: ['initiative', 'what is', 'about', 'who are you'], answer: "**HealingTech Initiative** is a modern social initiative — not a charity alone — using technology to create lasting impact. We focus on digital skills, scholarships, inclusion, AI literacy, women in tech, and youth empowerment across Malawi and Africa." },
        { keys: ['focus', 'programs', 'what do you do'], answer: "Our **focus areas** include digital skills training, scholarships, assistive technology, AI education, women in tech, youth innovation, and mentorship. Visit our **Programs** page for upcoming initiatives like Future Coders and AI for Malawi." },
        ...
        { keys: ['partner', 'donate', 'support'], answer: "You can **partner** with us, **donate** to expand technology education, or **support our mission** through HealingTech Labs' continued growth. Visit Partners or Donate pages for details." },
        ...
        { keys: ['support empower elevate', 'slogan', 'mission'], answer: "Our motto is **Support · Empower · Elevate** — using technology and education to uplift young people and communities." }
    ];
    ...
    function init() {
        ...
        addBotMessage("Hello! I'm the HealingTech Initiative assistant. Ask about our mission, HealingTech Labs, programs, volunteering, or partnerships.", true);
    }
